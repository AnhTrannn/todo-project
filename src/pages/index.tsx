...
const createTodo = async ({
  value,
  completed,
}: Omit<ITodo, "id">): Promise<ITodo | undefined> => {
  try {
...
function App({ isAuthentication = false }: Props): JSX.Element {
  ...
  return (
    <div>
      ...
      <Link className="bg-gray-600 fixed right-5 rounded p-2 mt-2 text-[#fff]" to={"/login"}>Logout</Link>
      </div>
